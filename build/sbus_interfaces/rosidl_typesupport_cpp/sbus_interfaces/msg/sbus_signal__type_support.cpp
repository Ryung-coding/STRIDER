...
static const _SbusSignal_type_support_symbol_names_t _SbusSignal_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sbus_interfaces, msg, SbusSignal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sbus_interfaces, msg, SbusSignal)),
  }
};
...
{
  return &::sbus_interfaces::msg::rosidl_typesupport_cpp::SbusSignal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sbus_interfaces, msg, SbusSignal)() {
  return get_message_type_support_handle<sbus_interfaces::msg::SbusSignal>();
}
