...
bool mocap_interfaces__msg__mocap_measured__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mocap_interfaces.msg._mocap_measured.MocapMeasured", full_classname_dest, 50) == 0);
  }
  mocap_interfaces__msg__MocapMeasured * ros_message = _ros_message;
  {  // pos
...
{
  /* NOTE(esteve): Call constructor of MocapMeasured */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mocap_interfaces.msg._mocap_measured");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MocapMeasured");
