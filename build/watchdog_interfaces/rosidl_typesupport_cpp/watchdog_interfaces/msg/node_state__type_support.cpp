...
static const _NodeState_type_support_symbol_names_t _NodeState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, watchdog_interfaces, msg, NodeState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, watchdog_interfaces, msg, NodeState)),
  }
};
...
{
  return &::watchdog_interfaces::msg::rosidl_typesupport_cpp::NodeState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, watchdog_interfaces, msg, NodeState)() {
  return get_message_type_support_handle<watchdog_interfaces::msg::NodeState>();
}
