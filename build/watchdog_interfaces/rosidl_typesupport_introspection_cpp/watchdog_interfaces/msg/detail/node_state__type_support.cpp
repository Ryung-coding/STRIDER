...
{
  new (message_memory) watchdog_interfaces::msg::NodeState(_init);
}

void NodeState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<watchdog_interfaces::msg::NodeState *>(message_memory);
  typed_message->~NodeState();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember NodeState_message_member_array[1] = {
  {
    "state",  // name
    ...
    offsetof(watchdog_interfaces::msg::NodeState, state),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers NodeState_message_members = {
  "watchdog_interfaces::msg",  // message namespace
  "NodeState",  // message name
  1,  // number of fields
  sizeof(watchdog_interfaces::msg::NodeState),
...
{
  return &::watchdog_interfaces::msg::rosidl_typesupport_introspection_cpp::NodeState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, watchdog_interfaces, msg, NodeState)() {
  return &::watchdog_interfaces::msg::rosidl_typesupport_introspection_cpp::NodeState_message_type_support_handle;
}
