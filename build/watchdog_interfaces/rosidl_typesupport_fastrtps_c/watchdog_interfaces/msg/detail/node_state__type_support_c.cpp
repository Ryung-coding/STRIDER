...
#include "watchdog_interfaces/msg/detail/node_state__rosidl_typesupport_fastrtps_c.h"
...
#include "watchdog_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _NodeState__ros_msg_type = watchdog_interfaces__msg__NodeState;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_watchdog_interfaces
size_t get_serialized_size_watchdog_interfaces__msg__NodeState(
  const void * untyped_ros_message,
...
static uint32_t _NodeState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_watchdog_interfaces__msg__NodeState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_watchdog_interfaces
size_t max_serialized_size_watchdog_interfaces__msg__NodeState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = watchdog_interfaces__msg__NodeState;
    is_plain =
      (
...
static size_t _NodeState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_watchdog_interfaces__msg__NodeState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, watchdog_interfaces, msg, NodeState)() {
