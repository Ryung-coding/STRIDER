...
bool allocator_interfaces__msg__pwm_val__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("allocator_interfaces.msg._pwm_val.PwmVal", full_classname_dest, 40) == 0);
  }
  allocator_interfaces__msg__PwmVal * ros_message = _ros_message;
  {  // f1
...
{
  /* NOTE(esteve): Call constructor of PwmVal */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("allocator_interfaces.msg._pwm_val");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PwmVal");
