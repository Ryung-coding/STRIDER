...
static const _PwmVal_type_support_symbol_names_t _PwmVal_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, allocator_interfaces, msg, PwmVal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, allocator_interfaces, msg, PwmVal)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, allocator_interfaces, msg, PwmVal)() {
  return &::allocator_interfaces::msg::rosidl_typesupport_c::PwmVal_message_type_support_handle;
}
